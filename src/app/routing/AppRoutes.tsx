      ...
      const fetchStaticDataWithAtom = async () => {
        try {
          ...
          if (
            ...
            antiActionTypesResponse.status !== 200
          ) {
            throw new Error(
            ...
            AntitheftActionTypes: ${antiActionTypesResponse.status} ${antiActionTypesResponse.statusText},`
            );
          }
          ...
          const data = {
            ...
            actionTypes: antiActionTypesResponse.data,
          };
