...
import { GroupsType } from "../../types/user-management.ts";
...
const GroupsPage = () => {
  ...
  const [tableData, setTableData] = useState<GroupsType[]>([
    {
      id: -1,
      name: "",
      description: "",
  ...
  const [newRowInput, setNewRowInput] = useState<Partial<GroupsType>>({});
  ...
  const handleSaveNewRow = () => {
    if (!newRowInput.name || !newRowInput.description) return;

    const newGroup: GroupsType = {
      id: Date.now(),
      name: newRowInput.name,
      description: newRowInput.description,
      members: 0,
    };
              ...
              <div className="col-12 d-flex align-items-center justify-content-between mb-4 ms-2">
                <div className="d-flex justify-content-between gap-3">
                  <div className="symbol symbol-50px ">
                    <h2>
                      <img src="https://img.icons8.com/?size=35&id=AQ7HFnm4p16c&format=png&color=000000" />{" "}
                      Groups
                    </h2>
